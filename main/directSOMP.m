...
%% MAIN CODE
% SOMP
DOA.x = somp(Dictionary.Plane.H, Direct.InnSph.H.', Dictionary.Plane.K);
DOA.Idx = find(DOA.x,Dictionary.Plane.K);
DOA.Est = Dictionary.Plane.uk(:,DOA.Idx);

if plotFlag
    uk = Dictionary.Plane.uk+Data.Sph.R0.';
