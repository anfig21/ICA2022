function Range = earlyRange_RLS(Data,Early,Dict,plotFlag)
%Range = earlyRange_RLS(Data,Early,Dict,plotFlag) Applies Regularised
...
%   Output:
%       - Range     : Range estimation via via RLS. Structure
%
...
elseif nargin < 3, error('earlyRange_RLS Error: Not enough input parameters.'), end
...
for rr = 1:Early.R
    for ii = 1:length(Dict.f)
        ...
        [x,~] = reguLeastSquares(Hii,pii,[],'true');
