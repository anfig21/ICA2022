function DOA = earlyDOA_CS(Data,Early,Dict)
%DOA = earlyDOA_CS(Data,Early,Dict) Applies Compressive Sensing to the
...
%% ERROR HANDLING
if nargin < 3, error('earlyDOA_CS Error: Not enough input parameters.'), end
